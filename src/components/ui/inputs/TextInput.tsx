    ...
    <div className={`w-full ${classNameParent}`}>
      ...
      <div className="relative">
        <input
          ...
          className={cn(
            "mt-1 block w-full px-3 py-2 pr-10 bg-white rounded-sm text-sm shadow-xs placeholder-slate-400 focus:outline-none focus:ring-1 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none",
            errors
